...
export function Headline(){
    return(
        <div style={Styles.main}>
            ...
            <Button href="https://pay.kirvano.com/d1be7de5-310e-4998-a00e-f27b74fec6ef" variant="contained" style={Styles.button}><h2>QUERO ME TORNAR UM ESPECIALISTA EM VENDAS ONLINE</h2></Button>
        </div>
    )
}